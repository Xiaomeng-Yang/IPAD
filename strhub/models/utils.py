...
def _get_model_class(key):
    if 'abinet' in key:
      ...
      from .pimnet.womimic_system import PIMNet as ModelClass
    elif 'mpnet' in key:
        from .mpnet.system import MPNet as ModelClass
    elif 'uncondition' in key:
        from .diffusion.uncondition_system_edit import DDPIMNet as ModelClass
    elif 'diffusion' in key:
        from .diffusion.system import DDPIMNet as ModelClass
