...
from strhub.data.utils import CharsetAdapter, CTCTokenizer, Tokenizer, BaseTokenizer, PIMNetTokenizer
...
class BaseSystem(pl.LightningModule, ABC):
    ...
    def _eval_step(self, batch, validation: bool) -> Optional[STEP_OUTPUT]:
        ...
        return dict(output=BatchResult(total, correct, ned, confidence, label_length, loss, loss_numel, pred_list, gt_list))
